...
* set the default tab icon display mode to Lucide and clarify the event type tooltip copy
...
## [4.0.0-beta.1 ~ beta.5] (Pre Release)

> Collapsed — contents merged into [4.0.0] above.
